...
public class end_time : MonoBehaviour {
    ...
    public static float Circle_radius_near = 0.004f;
    public static float Circle_radius_medium = 0.012f;
    public static float Circle_radius_far = 0.018f;

    public static float Circle_Convexity = 0.0001f;
    ...
    //static float[,] dw_pos = new float[10, 2] { { 1632, 408 }, { 1632, 204 }, { 1632, 102 }, { 1632, 51 }, { 1632, 25.5f }, { 408, 408 }, { 408, 204 }, { 408, 102 }, { 408, 51 }, { 408, 25.5f } };
    //public static float depth = 768;//设置实验的景深
    ...
    /// 测试穿过一个圆饼所用的时间
    /// </summary>
    public static int startsecond, endsecond; //一次实验的开始和结束对应的秒
    public static int startmillisecond, endmillisecond; //一次实验的开始和结束对应的毫秒 
    public static int deltasecond, deltamillisecond;
    public static int deltatime;
    public static int left_time = 0; //穿过左边目标的时间
    public static int right_time = 0; //穿过右边目标的时间
    public static int before_time = 0; //先穿过的目标时间
    public static int after_time = 0;  //后穿过的目标时间


    /*
    public void enter_test(Transform t) {
        if (ui_change.flag1 == 1)
        {
            ...
            if (OVRInput.Get(OVRInput.Button.One))
            {
                ...
                if (t.gameObject.name == "Cylinder1") {
                    ...
                    startmillisecond = System.DateTime.Now.Millisecond;
                }
            }
        }
    }
    */
    ...
    /// <summary>
    /// ray进入一个物体时调用，用于记录穿过物体的时间
    /// </summary>
    /// <param name="t"></param>
    public void Hover_Enter(Transform t)
    {
        if (ui_change.flag2 == 1 || ui_change.flag4 == 1 || ui_change.flag5 == 1) {
            ...
            if (OVRInput.Get(OVRInput.Button.One)) {
                ...
                if (t.gameObject.name == "Cylinder1") {
                    if ((start1 == 0 && start2 == 0 && start3 == 0 && start4 == 0)|| (start1 == 1 && start2 == 0 && start3 == 0 && start4 == 0))
                    {
                        startsecond = System.DateTime.Now.Second;
                        startmillisecond = System.DateTime.Now.Millisecond;
                    }
                    if ((start1 == 1 & start2 == 1 & start3 == 1 & start4 == 1)|| (start1 == 2 && start2 == 0 && start3 == 0 && start4 == 0)) {
                        startsecond = System.DateTime.Now.Second;
                        startmillisecond = System.DateTime.Now.Millisecond;
                    }
                }
                if (t.gameObject.name == "Cylinder3") {
                    if ((start1 == 1 && start2 == 1 && start3 == 0 && start4 == 0)|| (start1 == 1 && start2 == 1 && start3 == 1 && start4 == 0)) {
                        startsecond = System.DateTime.Now.Second;
                        startmillisecond = System.DateTime.Now.Millisecond;
                    }
                }
        ...
        if (ui_change.flag1 == 1) {
            ...
            if (OVRInput.Get(OVRInput.Button.One)) {
                ...
                if (t.gameObject.name == "Cylinder4") {
                    if ((start1 == 1 && start2 == 1 && start3 == 1 && start4 == 1)|| (start1 == 1 && start2 == 1 && start3 == 1 && start4 == 2)) {
                        startsecond = System.DateTime.Now.Second;
                        startmillisecond = System.DateTime.Now.Millisecond;
                    }
                }
                if (t.gameObject.name == "Cylinder2") {
                    if ((start1 == 1 && start2 == 1 && start3 == 2 && start4 == 2)|| (start1 == 1 && start2 == 2 && start3 == 2 && start4 == 2)) {
                        startsecond = System.DateTime.Now.Second;
                        startmillisecond = System.DateTime.Now.Millisecond;
                    }
                }
            ...
            if (OVRInput.Get(OVRInput.Button.One))
            {
                ...
                if (t.gameObject.name == "Cylinder2")
                {
                    if (start1 == 1 && start2 == 0 && start3 == 0 && start4 == 0)
                    {
                        ...
                        //记录穿过左边目标的时间
                        endsecond = System.DateTime.Now.Second;
                        endmillisecond = System.DateTime.Now.Millisecond;
                        deltasecond = endsecond - startsecond;
                        deltamillisecond = endmillisecond - startmillisecond;
                        if (deltamillisecond < 0)
                        {
                            deltamillisecond = deltamillisecond + 1000;
                            deltasecond = deltasecond - 1;
                        }
                        if (deltasecond < 0)
                        {
                            deltasecond = deltasecond + 60;
                        }
                        deltatime = deltasecond * 1000 + deltamillisecond;
                        left_time = deltatime;
                        before_time = left_time;
                        Debug.Log("穿过左边圆饼用时:" + left_time);
                    ...
                    else if (start1 == 2 && start2 == 0 && start3 == 0 && start4 == 0)
                    {
                        ...
                        deltatime = deltasecond * 1000 + deltamillisecond;
                        left_time = deltatime;
                        before_time = right_time;
                        after_time = left_time;
                        Debug.Log("穿过左边圆饼用时:" + left_time);
                ...
                if (t.gameObject.name == "Cylinder4")
                {
                    ...
                    if (start1 == 1 && start2 == 1 && start3 == 1 && start4 == 0)
                    {
                        ...
                        deltatime = deltasecond * 1000 + deltamillisecond;
                        right_time = deltatime;
                        before_time = left_time;
                        after_time = right_time;
                        Debug.Log("穿过右边圆饼用时:" + right_time);
        ...
        if (ui_change.flag1==1)
        {
            ...
            if (OVRInput.Get(OVRInput.Button.One))
            {
                ...
                if (t.gameObject.name == "Cylinder2")
                {
                    ...
                    else if (start1 == 1 && start2 == 1 && start3 == 2 && start4 == 2)
                    {
    ...
    public void Deltatime_recording() {
        ...
        while (before_time>300) {
            before_time = before_time - 100;
        }
        while (after_time > 300) {
            after_time = after_time - 100;
        }

        dt.Rows.Add(ui_change.Name, ui_change.exp_type, ui_change.block, C, depth, D1, W1, ID, angle, end_time.delta_time+before_time, end_time.is_error,before_time,after_time);

        //Debug.Log("穿过的时间不计入穿过前目标的时间为" + end_time.delta_time);
    ...
    public static void Change_pos(float x, float y) {
        ...
        if (posx == 2.448f)
        {
            ...
            if (ui_change.flag2 == 1 || ui_change.flag4 == 1)
            {
                ...
                objcube_trans.localScale = new Vector3(0.0225f, 2, 2);
        ...
        if (posx == 1.632f)
        {
            ...
            if (ui_change.flag2 == 1 || ui_change.flag4 == 1)
            {
                GameObject obj_cube = GameObject.Find("Cube");
                Transform objcube_trans = obj_cube.GetComponent<Transform>();
                objcube_trans.localScale = new Vector3(0.015f, 2, 2);
            }
        ...
        if (posx == 0.544f)
        {
            ...
            if (ui_change.flag2 == 1 || ui_change.flag4 == 1)
            {
                GameObject obj_cube = GameObject.Find("Cube");
                Transform objcube_trans = obj_cube.GetComponent<Transform>();
                objcube_trans.localScale = new Vector3(0.005f, 2, 2);
            }
        ...
        if (ui_change.flag2 == 1) {
            ...
            //调整scale的大小（直径大小）
            obj1_trans.localScale = new Vector3(scale, thickness, scale);
            obj2_trans.localScale = new Vector3(scale, thickness, scale);
            obj3_trans.localScale = new Vector3(scale, thickness, scale);
            obj4_trans.localScale = new Vector3(scale, thickness, scale);
            obj34up_trans.localScale = new Vector3(Circle_radius+Circle_radius, thickness, Circle_Convexity);
            obj34down_trans.localScale = new Vector3(Circle_radius + Circle_radius, thickness, Circle_Convexity);
        }
        if (ui_change.flag5 == 1) {
            //调整位置信息
    ...
    public static void Change_pos_b(float x, float y) {
        ...
        obj1_trans.localScale = new Vector3(scale, scale, scale);
        obj2_trans.localScale = new Vector3(scale, scale, scale);
